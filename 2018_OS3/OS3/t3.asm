...
main(int argc, char **argv)
{
  ...
  41:	83 c4 10             	add    $0x10,%esp
	...
	ppid = getpid();
  44:	e8 49 03 00 00       	call   392 <getpid>
  49:	89 45 f4             	mov    %eax,-0xc(%ebp)
	pid = fork();
  4c:	e8 b9 02 00 00       	call   30a <fork>
  51:	89 45 f0             	mov    %eax,-0x10(%ebp)

	if(pid==0){
  54:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  58:	75 45                	jne    9f <main+0x7e>
		recursion(500);
  ...
  80:	e8 bd 02 00 00       	call   342 <kill>
  85:	83 c4 10             	add    $0x10,%esp
		printf(1, "OK\n");
  88:	83 ec 08             	sub    $0x8,%esp
  8b:	68 4f 08 00 00       	push   $0x84f
  90:	6a 01                	push   $0x1
  92:	e8 fa 03 00 00       	call   491 <printf>
